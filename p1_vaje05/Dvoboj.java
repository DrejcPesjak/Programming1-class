...
public class Dvoboj {
	...
	/**
	 * Simulira partijo Anja-Bojan in vrne 1, ce zmaga Anja, 2 ce 
	 * zmaga Bojan in 0, ce se partija zakljuci z remijem.
	 */
    ...
    public static void main(String[] args) {
		...
		while (stZmagAnja < ciljnoStZmag && stZmagBojan < ciljnoStZmag) {
			int izid = simulirajPartijo(random, verjAnja, verjBojan);
